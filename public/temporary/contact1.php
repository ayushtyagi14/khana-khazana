                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="menu-wrapper  d-flex align-items-center justify-content-end">
                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="program.html">SDG's</a></li>
                                ...
                                <div class="header-right-btn d-none d-lg-block ml-20">
                                    <a href="/ngo-dashboard" target="_blank" class="btn header-btn">Secure Food</a>
                                </div>
                                <div class="header-right-btn d-none d-lg-block ml-20">
                                    <a href="/login" target="_blank" class="btn header-btn">DashBoard</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
...
?>
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>support@Khanakhazana.com</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Contact Info</h4>
                                    <ul>
                                        <li><a href="#">Phone : +91 999xx xxxxx</a></li>
                                        <li><a href="#">Email : xyz@Khanakhazana.com</a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <div class="footer-pera footer-pera2">
                                    <p>Empowering Communities Through Food.</p>
                                </div>
                                <!-- Form -->
